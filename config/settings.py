...
SECRET_KEY = 'django-insecure-)-#alw0emx+2%7e#ff0uijfopa5i4ouw=&-((i-!=l9+2!vnja'
...
INSTALLED_APPS = [
    ...
    # 'django.contrib.auth',
    'apps.attandance.custom_auth_config.CustomAuthConfig',
...
AUTH_USER_MODEL = 'attandance.CustomUser'
